    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">hrittik0chatterjee@gmail.com</span>
                        
                        <a href="mailto:hrittik0chatterjee@gmail.com" className="contact__button" >
                            Write Me{" "} 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">hrittik-chatterjee</span>
                        
                        <a href="https://www.linkedin.com/in/hrittik-chatterjee/" className="contact__button" target="_blank"  rel="noreferrer">
                            Write Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
                    ...
                    <div className="contact__card">
                    <RiTwitterXLine  className="contact__card-icon" />
                        
                        <h3 className="contact__card-title">X(Twitter)</h3>
                        <span className="contact__card-data">@hrittik_</span>
                        
                        <a href="https://twitter.com/hrittik_" className="contact__button" target="_blank"  rel="noreferrer">
                            Write Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
            ...
            <div className="contact__content">
                ...
                <h3 className="contact__title">What is the project?</h3>
